...
public class ServerSideThread extends Thread
{
	...
	public ServerSideThread(Socket socketObj)
	{
	...
	public void run()
	{
		...
		DataOutputStream opStream = null;
		
		try
		{
			ipStream = new DataInputStream(socketObj.getInputStream());
			opStream = new DataOutputStream(socketObj.getOutputStream());
	...
	protected static boolean writeFileToServer(String fileName, String fileContent)
	{
		...
		if(fileContent.equals("") || fileContent.isEmpty() || fileContent == null)
		{
			return fileWrite;
		}
